...
$cmtcontent=mysqli_result($result,0,"content");
      ...
      <div class='container'>
        <form method=post action=cmtmodify2.php?board=$board&id=$id&cpage=$cpage&num=$num>
          <div style='padding:10px;'>
            ...
            <div style='width:259px; display:inline-block;'><input type=text name=writer size=30 value='$cmtname'></div>
            <div style='width: 45px; display:inline-block;'>Email </div>
            <div style='display:inline-block;'><input type=text name=email size=44 value='$cmtemail'></div>
          </div>
          <div style='padding:10px;'><textarea name=content rows=8 cols=100>$cmtcontent</textarea></div>
          <div style='padding:10px;'>
